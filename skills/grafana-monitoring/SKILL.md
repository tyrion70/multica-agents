...
- Base `https://chained.grafana.net/api`:
  ...
  - Ad-hoc LogQL: `GET /api/datasources/proxy/uid/<ds>/loki/api/v1/query_range?query=…&start=…&end=…&limit=…`
    Example: `/api/datasources/proxy/uid/cf30fmh2llypse/loki/api/v1/query_range?query={namespace="chainlink"}&start=1719500000000000000&end=1719503600000000000&limit=100`
...
| `grafanacloud-logs` | Loki — synthetic monitoring |
| `cf30fmh2llypse` | Loki — k8s pod logs |
