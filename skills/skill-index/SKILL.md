...
| Skill | Description | Bound squad members |
|---|---|---|
...
2. Update `Chainlayer/skills.json` if the skill belongs to the Chainlayer workspace.
3. If binding an existing skill to a new agent, update the "Bound squad members" column.
